...
AngularJS формирует страницы с вопросами, синхронизирует их с данными из базы. Используются директивы (directive) и отслеживание изменений данных с помощью $watch.
